...
START_TEST(test_s21_calculation) {
    ...
    compare_calc("-ln (89.2*6^8)-32-(-++++(9) mod 1+(-6.02-3^5.1)/+++-+(3.7))", -9.4461611);
    ...
    failure_calc("999999999999999999999999999^99999999999999999999999999999999999999999999999999");
    compare_calc("999999999999999999999999999^-99999999999999999999999999999999999999999999999999", 0);
    compare_calc("999^-2", 0.000001002);
    compare_calc("999999999999999999999999999^-(1/4)", 0.000000178);
    compare_calc("999999999999^9", 999999999991000000000035999999999916000000000125999999999874000000000083999999999964000000000008999999999999.0);
